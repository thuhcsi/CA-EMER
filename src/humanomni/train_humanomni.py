...
class ModelArguments:
    ...
    bert_model: Optional[str] = field(default=None)
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        inputs_bert = self.bert_tokenizer(prompts_bert, return_tensors='pt', padding=True, truncation=True,add_special_tokens=True)
...
def make_supervised_data_module(tokenizer: transformers.PreTrainedTokenizer,
    ...
    data_collator = DataCollatorForSupervisedDataset(tokenizer=tokenizer, bert_tokenizer=bert_tokenizer)
...
def train(attn_implementation=None):
   ...
   # import ipdb; ipdb.set_trace()
    ...
    bert_tokenizer = BertTokenizer.from_pretrained(model_args.bert_model)
    ...
    data_module = make_supervised_data_module(tokenizer=tokenizer, data_args=data_args, bert_tokenizer=bert_tokenizer)
